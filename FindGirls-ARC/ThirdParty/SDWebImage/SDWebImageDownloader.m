...
{
    return [self downloadImageWithURL:url size:CGSizeZero options:options progress:progressBlock completed:completedBlock];
}
                                                                ...
                                                                completed:^(UIImage *image, NSData *data, NSError *error, BOOL finished)
                      {
                          ...
                          for (NSDictionary *callbacks in callbacksForURL)
                          {
                              ...
                              if (!CGSizeEqualToSize(size, CGSizeZero)) {
                                  image = [image resizedImage:size interpolationQuality:kCGInterpolationLow];
                              }
